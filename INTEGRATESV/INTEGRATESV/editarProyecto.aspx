<%@ Page Title="" Language="C#" MasterPageFile="~/MenuEmpleado.Master" AutoEventWireup="true" CodeBehind="editarProyecto.aspx.cs" Inherits="INTEGRATESV.editarProyecto" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="form-center">
        <form id="form1" runat="server" class="form-group col-md-8 align-content-center">
            <div class="col py-3">
                <h1>Formulario para Editar proyecto</h1>
                <p>&nbsp;</p>
                <div class="form-row">
                ...
                <div class="text-center">
                    <asp:Button ID="Button1" runat="server" Text="Aplicar Cambios" class="btn btn-success" />
                    <asp:Button ID="Button2" runat="server" Text="Cancelar" class="btn btn-danger" />
                </div>
            </div>
        </form>
    </div>
